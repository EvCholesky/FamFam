...
#define OPCODE_TABLE \
        OP(00, BRK,IMP, 7)  OP(01, ORA,IXR, 6)  OP(02, KIL,IMP, 1)  OP(03, SLO,IXR, 8)  OP(04, NOP,ZPG, 3)  OP(05, ORA,ZPG, 3)  OP(06, ASL,ZPG, 5)  OP(07, SLO,ZPG, 5) OP(08, PHP,IMP, 3)  OP(09, ORA,IMM, 2) OPA(0A, ASL,ACC, 2)  OP(0B, ANC,IMM, 2)  OP(0C, NOP,ABS, 4)  OP(0D, ORA,ABS, 4)  OP(0E, ASL,ABS, 6)  OP(0F, SLO,ABS, 6) \
        ...
        OP(20, JSR,ABS, 2)  OP(21, AND,IXR, 6)  OP(22, KIL,IMP, 1)  OP(23, RLA,IXR, 8)  OP(24, BIT,ZPG, 3)  OP(25, AND,ZPG, 3)  OP(26, ROL,ZPG, 5)  OP(27, RLA,ZPG, 5) OP(28, PLP,IMP, 4)  OP(29, AND,IMM, 2) OPA(2A, ROL,ACC, 2)  OP(2B, ANC,IMM, 2)  OP(2C, BIT,ABS, 4)  OP(2D, AND,ABS, 4)  OP(2E, ROL,ABS, 6)  OP(2F, RLA,ABS, 6) \
        ...
        OP(40, RTI,IMP, 6)  OP(41, EOR,IXR, 6)  OP(42, KIL,IMP, 1)  OP(43, SRE,IXR, 8)  OP(44, NOP,ZPG, 3)  OP(45, EOR,ZPG, 3)  OP(46, LSR,ZPG, 5)  OP(47, SRE,ZPG, 5) OP(48, PHA,IMP, 3)  OP(49, EOR,IMM, 2) OPA(4A, LSR,ACC, 2)  OP(4B, ALR,IMM, 2)  OP(4C, JMP,ABS, 3)  OP(4D, EOR,ABS, 4)  OP(4E, LSR,ABS, 6)  OP(4F, SRE,ABS, 6) \
        ...
        OP(60, RTS,IMP, 6)  OP(61, ADC,IXR, 6)  OP(62, KIL,IMP, 1)  OP(63, RRA,IXR, 8)  OP(64, NOP,ZPG, 3)  OP(65, ADC,ZPG, 3)  OP(66, ROR,ZPG, 5)  OP(67, RRA,ZPG, 5) OP(68, PLA,IMP, 4)  OP(69, ADC,IMM, 2) OPA(6A, ROR,ACC, 2)  OP(6B, ARR,IMM, 2)  OP(6C, JMP,IND, 5)  OP(6D, ADC,ABS, 4)  OP(6E, ROR,ABS, 6)  OP(6F, RRA,ABS, 6) \
